...
/// <summary>
///     This class maintains the structure of our AWS S3 service provider that forces XML serialization and deserialization
/// </summary>
public class XmlAwsSimpleStorageService : AwsSimpleStorageService, IAwsSimpleStorageService
{
    /// <summary>
    ///     This method instantiates an AWS S3 service that forces XML serialization and deserialization
    /// </summary>
    /// <param name="configuration">The configuration values to use</param>
    public XmlAwsSimpleStorageService(AwsSimpleStorageServiceClientConfiguration configuration) : base(new()
    {
        ...
        SerializationFormat = SerializerFormat.Xml
    })
    {
    }
    ...
    public XmlAwsSimpleStorageService(string accessKeyId, string secretAccessKey, string region = null,
