...
public class AwsSimpleStorageService : IAwsSimpleStorageService
{
    ...
    public Task<List<S3Object>> ListObjectsAsync(string objectPrefix) =>
        AwsSimpleStorageServiceClient.ListObjectsAsync(objectPrefix, _configuration);
    ...
    public Task<List<TOutput>> ListObjectsAsync<TOutput>(string objectPrefix) =>
        AwsSimpleStorageServiceClient.ListObjectsAsync<TOutput>(objectPrefix, _configuration);
    ...
    public Task
        UploadAsync(string objectName, Stream data, MetadataCollection metadata = null, S3CannedACL acl = null) =>
        AwsSimpleStorageServiceClient.UploadAsync(objectName, data, _configuration, metadata,
    ...
    /// <param name="acl">Optional access control for the object</param>
    /// <returns>An awaitable task with no result</returns>
    public Task UploadAsync(string objectName, byte[] binary, MetadataCollection metadata = null,
    ...
    /// <param name="acl">Optional access control for the object</param>
    /// <returns>An awaitable task with no result</returns>
    public Task UploadAsync(string objectName, string localPathOrContent, MetadataCollection metadata = null,
    ...
    public Task UploadAsync<TSource>(string objectName, TSource content, MetadataCollection metadata = null,
        S3CannedACL acl = null) => AwsSimpleStorageServiceClient.UploadAsync<TSource>(objectName, content,
        _configuration, metadata, acl ?? S3CannedACL.Private);
    ...
    public Task UploadAsync<TSource>(string objectName, string localDirectoryFileOrContent,
        MetadataCollection metadata = null, S3CannedACL acl = null) =>
